...
public class StudentManagementSystem1 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String password = "7733";  // 👉 Change this if your password is different
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    String insertSQL = "INSERT INTO student (name, age, course, city) VALUES (?, ?, ?, ?)";
                ...
                case 2:
                    String viewSQL = "SELECT * FROM student ORDER BY id";
